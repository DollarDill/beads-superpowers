...
- [obra/superpowers](https://github.com/obra/superpowers) v6.3.0 — composable skills for AI agents (MIT)
- [gastownhall/beads](https://github.com/gastownhall/beads) v1.2.2 — Persistent issue tracker for AI agents (MIT)

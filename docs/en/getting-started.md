...
| Hermes Agent | `hermes plugins install DollarDill/beads-superpowers` | - | registers skills natively and injects the bootstrap (including beads context) via `pre_llm_call`; config validated by us, not E2E-tested |

...
6. **Write design doc** — save to `docs/beads-superpowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/beads-superpowers/specs/YYYY-MM-DD-<topic>-design.md`

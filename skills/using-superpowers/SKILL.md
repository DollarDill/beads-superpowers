...
Skills use Claude Code tool names. Non-CC platforms: see `references/codex-tools.md` (Codex), `references/copilot-tools.md` (Copilot CLI), `references/gemini-tools.md` (Gemini CLI), and `references/opencode-tools.md` (OpenCode) for tool equivalents. Gemini CLI users get the tool mapping loaded automatically via GEMINI.md.

...
Execute this plan using the `beads-superpowers:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/beads-superpowers-test/fractals`

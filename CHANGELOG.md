...
- `example-workflow/agents/yegge.md` — Complete orchestrator agent with 11-state FSM, request triage, planning principles, critical rules, and session protocol. Named after Steve Yegge (beads creator). Replaces monolithic CLAUDE.md-as-agent pattern.
...
- `example-workflow/agents/researcher.md` — Replaced by `jesse.md` (same content, renamed with attribution to Jesse Vincent).
